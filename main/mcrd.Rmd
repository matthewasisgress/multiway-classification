...
In this demonstration, we apply R package **cpfa** (Asisgress, 2025) to the 
MNIST dataset (LeCun, Cortes, and Burges, 1998; LeCun et al., 2002)---showing 
how to use the package to distinguish between digits of 2 and 3, a binary
classification problem. We further apply the package to the Fashion MNIST
dataset (Xiao, Rasul, and Vollgraf, 2017)---distinguishing among images of tops, 
trousers, and sandals, which is a multiclass classification problem.
...
we use 10-fold cross-validation (CV) in our inner training, setting 
