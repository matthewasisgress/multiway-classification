...
between 22 and 25. This third component might be capturing zero values to the 
...
Finally, for this analysis, we set `parallel = TRUE` to use parallel computing,
...
Accuracy values are between 0.64 and 0.70. The three-component Parafac model 
...
Accuracy values are between 0.54 and 0.65. The four-component Parafac2 model 
with the SVM classifier performed best. In addition, average optimal tuning 
parameters are available for each classifier. 
