...
Describe downloading the dataset.
...
Conduct an analysis of the MNIST dataset using R package **cpfa**.
...
outputR <- cpfa(x = X, y = y, model = model, nfac = 3, nrep = 5, 
                ...
                seeds = NULL, plot.out = TRUE, parallel = TRUE, const = const, 
                nstart = nstart)
...
Discuss results for metrics.

### Plots

Describe plots to be produced.
